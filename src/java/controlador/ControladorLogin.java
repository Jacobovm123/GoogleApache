...
import model.Google_Token_Claims_Model;
import model.JWTDecoder;

import model.PersonaDAO;
import model.Tokens_Model;
...
public class ControladorLogin extends HttpServlet {
 private String redirectURI="https://84105f1360a8.ngrok.io/GoogleApache/ControladorLogin";
	...
	post.setHeader("Content-Type", "application/x-www-form-urlencoded");
        ...
        Tokens_Model tokens= new com.google.gson.Gson().fromJson(result.toString(),Tokens_Model.class);

        Google_Token_Claims_Model claimsGoogle=new com.google.gson.Gson().fromJson(JWTDecoder.getClaims(tokens.id_token),Google_Token_Claims_Model.class);
            ...
            response.addCookie(cookie);
                   ...
                   if(ab.getCargo().equals("admin")){
                       ...
                       response.sendRedirect("MenuAdmin.jsp");
                        ...
                        if(ab.getCargo().equals("userh")){
                
                            
                            
                            
                            response.sendRedirect("MenuUser1.jsp");
